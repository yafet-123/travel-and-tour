...
export const Featured: React.FC = () => {
	const FieldTour = [
    {
      ...
      description: 'Transportation: Drive and flight Duration: 7 Days/ 6 Nights Accommodation: Hotels and Lodge',
    },
    {
      image: featureImageTwo,
      name: 'Ethiopian History and Nature',
      description: 'Transportation: Flight and Drive Duration: 14 Days/ 13 Nights Accommodation: Lodges, Hotel, and Resorts',
    },
    {
      image: featureImageTwo,
      name: 'Ethiopian History and Nature',
    ...
    <section className="mx-auto max-w-7xl mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
      	{FieldTour.map((data,index)=>(
      		<div key={index} className="w-[600px] h-[281px] bg-green-300 relative">
      			<Image
              src={data.image}
