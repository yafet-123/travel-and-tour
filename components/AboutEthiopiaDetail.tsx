...
import year from '../public/adey ababa.png';
import CompleteIndependence from '../public/Ethiopian_Warriors.jpg';
import ReligiousFestivals from '../public/Addis-Ababa-Meskel-1.jpg';
import Nature from '../public/Ethiopia-Simien-Mountains.jpg';
import lucy from '../public/lucy.jpeg';
import ProudTraditions from '../public/tradition image 1.jpg';
        ...
        {Detail.map((data, index) => (
          <div className="flex flex-col lg:flex-row lg:even:flex-row-reverse mb-3">
            ...
            <div className="w-full lg:w-1/2 lg:px-10 p-5 lg:p-0 my-auto">
              <Image
                src={data.image}
                className="w-full h-[300px] object-fit brightness-75 border rounded-2xl hover:scale-110 transition duration-500"
                priority
                alt="AboutUsEthiopia"
              />
            </div>
